...
const RightSideModal = ({ isOpen, onClose, title, children, size = 'md' }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 h-full w-full ${sizeClasses[size]} bg-white shadow-[-10px_0_30px_rgba(0,0,0,0.2)] z-[90] transform transition-transform duration-300 ease-in-out animate-in slide-in-from-right overflow-hidden`}
      >
        <div className="flex h-full flex-col">
          ...
          <div className="bg-black px-6 py-5 flex items-center justify-between relative">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-gray-500 font-bold uppercase tracking-[2px]">
                5L Allied Services
              </span>
            </div>
          ...
          <div className="shrink-0 w-full bg-gray-50 border-t border-gray-100 p-4 text-center">
            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest italic">
              Confidential Accounting Record
            </p>
          </div>
        </div>
      </div>
