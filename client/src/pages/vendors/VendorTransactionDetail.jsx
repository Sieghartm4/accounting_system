...
import { Truck, ArrowLeft, Calendar } from 'lucide-react'
...
function VendorTransactionDetailContent({ vendorId, vendorName, onBack }) {
  const { disbursements, purchases, loading, error } =
    useVendorTransactionDetail(vendorId)
  ...
  const filteredDisbursements = filterByDate(
    disbursements,
    'payment_date',
    'payment_date',
  )
...
export default function VendorTransactionDetail({ vendorId, vendorName, onBack }) {
  return (
    <RouteProtection routeName="vendors">
      <VendorTransactionDetailContent
        vendorId={vendorId}
