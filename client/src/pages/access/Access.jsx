...
function AccessContent() {
  ...
  const routeAccessOptions = [
    ...
    { value: 'Add Access', label: 'Add Access' },
        ...
        >
          <div>
            ...
            <p className="text-gray-500 text-sm font-medium">
              Define user roles, route permissions, and system-wide security
              protocols.
            </p>
          </div>
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-2 gap-8 pb-4">
        ...
        >
          <DynamicTable
            ...
            highlightRow={
              selectedAccessId
                ? { column: 'access_id', value: selectedAccessId }
                : null
            }
            badgeColumns={[
              {
          ...
          {selectedAccessId ? (
            ...
            <div className="h-full flex flex-col items-center justify-center bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 p-10 text-center">
              ...
              <p className="text-xs text-gray-400 mt-2 max-w-[200px]">
                Choose an access level from the left to inspect specific route
                permissions.
              </p>
            </div>
          )}
