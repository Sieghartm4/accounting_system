        ...
        const fetchSalesData = async () => {
          ...
          try {
            ...
            const newItems = result.data.map((s) => {
              ...
              const remainingBalance = totalDue - paidAmount - pendingCollections
              ...
              return {
                ...
                toPay: remainingBalance, // Auto-calculate: amount due - paid amount - pending collections
    ...
    try {
      ...
      const newItems = result.data.map((s) => {
        ...
        return {
          ...
          pendingCollections: pendingCollections, // display only - pending collections not yet approved
                    ...
                    <div className="overflow-x-auto custom-scrollbar">
                      ...
                      >
                        ...
                        <colgroup>
                          ...
                          <col style={{ width: '12%' }} /> {/* Pending Collections */}
                              ...
                              <td className="py-2 px-2 text-center">
                                ...
                                {!isViewMode && !isEditMode ? (
                                  ...
                                  <input
                                    ...
                                    className={`w-full px-2 py-1 text-right border rounded focus:outline-none focus:ring-2 text-xs ${item.toPay > (item.gross - item.paidAmount)
                        ...
                        <tfoot className="border-t-2 border-gray-200 bg-gray-50/80 font-black text-xs">
                          <tr>
                            {/* Spans ID, Doc Ref, and Remarks (3 columns) */}
                            <td
                              colSpan={3}
        ...
        <div className="space-y-4">
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-center">
                            ...
                            <span
                              ...
                              className={`inline-flex items-center px-2.5 py-0.5 text-[10px] font-black rounded-full border ${sale.status === 'COLLECTED'
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              ...
              className={`px-6 py-2 text-[12px] font-black rounded-lg uppercase tracking-wider transition-colors ${selectedSales.length === 0
