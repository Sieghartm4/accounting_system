...
const { getAdjustments, createAdjustment, getAdjustmentById, updateAdjustment, updateAdjustmentData, cancelAdjustmentState } = require('../controller/adjustments.controller')
...
adjustmentsRouter.put('/cancel-state', cancelAdjustmentState)
