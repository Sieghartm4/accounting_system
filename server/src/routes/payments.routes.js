...
const { getPayments, getAllPayments, getPurchasePayment, getPurchaseItemsPayment, createPayment, updatePaymentState, getPrintPayments } = require('../controller/payments.controller')
