...
const getAllCompanies = async (req, res, next) => {
  try {
    const statement = sql
      .selectAll(Master.master_company.tablename)
...
const createCompany = async (req, res, next) => {
  try {
    ...
    queries.push({
      sql: sql
        .insert(Master.master_company.tablename, {
...
const updateCompany = async (req, res, next) => {
  try {
    ...
    const existingQuery = sql
      .select([
        Master.master_company.selectOptionColumns.company_name,
        Master.master_company.selectOptionColumns.owner_name,
        Master.master_company.selectOptionColumns.address,
        Master.master_company.selectOptionColumns.tin,
        Master.master_company.selectOptionColumns.website,
        Master.master_company.selectOptionColumns.email,
        Master.master_company.selectOptionColumns.phone,
        Master.master_company.selectOptionColumns.status,
      ])
      .from(Master.master_company.tablename)
    ...
    const updateStatement = sql
      .update(Master.master_company.tablename, {
        prefix: Master.master_company.prefix,
      })
      .set(updateColumns)
