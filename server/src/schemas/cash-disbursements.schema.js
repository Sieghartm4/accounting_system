...
const CashDisbursementsField = {
    ...
    All: ['id', 'vendor_id', 'document_reference', 'payment_date', 'mode_of_payment', 'bank_name', 'check_number', 'category', 'remarks', 'total_amount_due', 'status', 'state', 'created_date', 'created_by'],
};
