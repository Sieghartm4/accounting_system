...
const CashDisbursementItemsField = {
    ...
    All: ['id', 'cash_disbursement_id', 'product_service', 'charts_of_accounts', 'description', 'unit', 'quantity', 'purchase_price', 'discount', 'vat', 'witholding_tax', 'responsibility_center'],
};
